...
def listar_arquivos_bucket(nome_bucket: str):
    response = _s3_client.list_objects_v2(Bucket=nome_bucket)
    return response
...
if __name__ == '__main__':
    ...
    enviar_base64('qrcode2', imagem_base64, 'qrcore-janeiro-2025-ap1.png', 'image/png')
    
    list_buckets()

    objects = listar_arquivos_bucket("qrcode2")
